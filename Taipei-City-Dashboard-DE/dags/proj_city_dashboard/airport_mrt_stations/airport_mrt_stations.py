...
def _airport_mrt_stations(**kwargs):
    ...
    # LineID is present in TDX TYMC response; fallback "AL" = Airport Line
    data["line_id"] = data["LineID"] if "LineID" in data.columns else "AL"
    ...
    # Load — replace only tymc rows atomically
