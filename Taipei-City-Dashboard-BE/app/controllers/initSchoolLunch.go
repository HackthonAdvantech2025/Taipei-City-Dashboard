...
func InitSchoolLunch(c *gin.Context) {
	...
	VALUES 
		-- Da'an District
		('大安國小', '大安區', 'Organic', 25.5, '2024-04-01'),
		('大安國小', '大安區', 'TAP', 30.2, '2024-04-01'),
		('大安國小', '大安區', 'CAS', 20.1, '2024-04-01'),
		('大安國小', '大安區', 'QR_Code', 24.2, '2024-04-01'),
		-- Xinyi District
		('信義國小', '信義區', 'Organic', 22.1, '2024-04-01'),
		('信義國小', '信義區', 'TAP', 35.5, '2024-04-01'),
		('信義國小', '信義區', 'CAS', 18.2, '2024-04-01'),
		('信義國小', '信義區', 'QR_Code', 24.2, '2024-04-01'),
		-- Beitou District
		('北投國小', '北投區', 'Organic', 28.4, '2024-04-01'),
		('北投國小', '北投區', 'TAP', 28.2, '2024-04-01'),
		('北投國小', '北投區', 'CAS', 22.1, '2024-04-01'),
		('北投國小', '北投區', 'QR_Code', 21.3, '2024-04-01'),
		-- Shilin District
		('士林國小', '士林區', 'Organic', 24.5, '2024-04-01'),
		('士林國小', '士林區', 'TAP', 32.1, '2024-04-01'),
		('士林國小', '士林區', 'CAS', 20.4, '2024-04-01'),
		('士林國小', '士林區', 'QR_Code', 23.0, '2024-04-01'),
		-- Neihu District
		('內湖國小', '內湖區', 'Organic', 26.1, '2024-04-01'),
		('內湖國小', '內湖區', 'TAP', 29.8, '2024-04-01'),
		('內湖國小', '內湖區', 'CAS', 21.5, '2024-04-01'),
		('內湖國小', '內湖區', 'QR_Code', 22.6, '2024-04-01');
	`
    ...
    models.DBDashboard.Exec(`
        INSERT INTO school_lunch_traceability (school_name, district, cert_type, proportion, record_date) 
        VALUES 
            ('中山國小', '中山區', 'Organic', 23.4, '2024-04-01'), ('中山國小', '中山區', 'TAP', 31.2, '2024-04-01'),
            ('萬華國小', '萬華區', 'Organic', 20.5, '2024-04-01'), ('萬華國小', '萬華區', 'TAP', 34.5, '2024-04-01'),
            ('文山國小', '文山區', 'Organic', 27.2, '2024-04-01'), ('文山國小', '文山區', 'TAP', 27.8, '2024-04-01'),
            ('松山國小', '松山區', 'Organic', 25.1, '2024-04-01'), ('松山國小', '松山區', 'TAP', 30.5, '2024-04-01'),
            ('中正國小', '中正區', 'Organic', 24.8, '2024-04-01'), ('中正國小', '中正區', 'TAP', 32.6, '2024-04-01'),
            ('大同國小', '大同區', 'Organic', 21.2, '2024-04-01'), ('大同國小', '大同區', 'TAP', 33.9, '2024-04-01'),
            ('南港國小', '南港區', 'Organic', 26.5, '2024-04-01'), ('南港國小', '南港區', 'TAP', 29.1, '2024-04-01');
    `)
